        ...
        <>
          ...
          <div className="grid grid-cols-5 shrink-0" style={{ borderTop: `1px solid ${t.border}` }}>
            {[
              ...
              { l: 'Saldo NOP', v: dreData ? fmtInt(dreData.rnop - dreData.dnop) : '0', c: dreData && (dreData.rnop - dreData.dnop) >= 0 ? t.green : t.red, sub: dreData && dreData.rob ? `${(((dreData.rnop - dreData.dnop) / dreData.rob) * 100).toFixed(1)}% sobre RoB` : 'RNOP − DNOP' },
